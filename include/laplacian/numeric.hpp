namespace laplacian {
    ...
    const float Gaussian1::kernel[9] = {
    ...
    struct Gaussian2 {
        static const float kernel[15];
        static const int size = 15;
        static const int center = 8;
    };

    const float Gaussian2::kernel[15] = {
    ...
    struct Gaussian3 {
        static const float kernel[23];
        static const int size = 23;
        static const int center = 11;
    };

    const float Gaussian3::kernel[23] = {
    ...
    const float Gaussian4::kernel[29] = {
